---
title: "Mini-Accum KISS — Plan Operativo (canónico)"
version: "v1.0"
date: "2025-10-01"
status: "CANÓNICO"
---

# 📜 Plan Operativo — Mini‑Accum KISS

Este documento consolida **mini_accum_plan.md** y **mini_bot_macro_plan.md** bajo una sola fuente de verdad.

## 1) Plan Operativo (KISS v1)
...
## 2) Macro‑Plan (Estrategia y Alcance)
_(No se encontró mini_bot_macro_plan.md; incluir aquí la visión macro y alcance)._ 

---

## 3) KPIs de gobierno
- NetBTC vs HODL (BTC benchmark)  
- MDD vs HODL · FPY (≤ 26/año; soft ≤ 2/mes)  
- SPA/RC/DSR/PBO (pruebas estadísticas)
